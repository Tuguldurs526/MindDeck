...
export default function LandingPage() {
  ...
  return (
    ...
    >
      {/* Shared centered layout container */}
      <div className="page-main">
        <header
          style={{
            ...
            gap: "1rem",
            marginBottom: "2rem",
            flexWrap: "wrap", // ✅ better on mobile
          }}
        >
        ...
        <main>
          {/* ✅ Use shared responsive grid helper */}
          <section className="page-grid-2-wide">
            ...
            <div>
              <p
                style={{
                  ...
                  borderRadius: 999,
                  backgroundColor: "rgba(158, 88, 223, 0.15)",
                  fontSize: "0.8rem",
                  marginBottom: "0.75rem",
                  border: "1px solid rgba(148,163,184,0.4)",
                  color: "#111827", // ✅ dark text on light pill
                }}
              >
              ...
              <div
                style={{
                  ...
                  flexWrap: "wrap", // ✅ buttons wrap nicely on mobile
                }}
              >
            ...
            >
              ...
              >
                ...
                >
                  A: Because the air beneath it is even denser, creating an
                  upward buoyant force.
                </p>
              </div>
              <p style={{ fontSize: "0.85rem", color: "#6b7280" }}>
                Upload notes → Minddeck generates flashcards → you review them
                at the right time with spaced repetition.
              </p>
            </div>
          </section>
        </main>
